...
/*
 ...
 Source Schema         : cloudlibrary_plus

 Target Server Type    : MySQL
 Target Server Version : 50717
 File Encoding         : 65001

 Date: 04/01/2021 15:46:54
*/
...
-- ----------------------------
INSERT INTO `book`
VALUES (1, 'Java基础案例教程（第2版）', '9787115547477', '人民邮电出版社', '传智播客', 291, 59, '2020-12-11', '3', '', '',
        '');
INSERT INTO `book`
VALUES (2, '挪威的森林', '9787546205618', '上海译文出版社', '村上春树', 380, 34, '2020-12-12', '1', '张三',
        '2020-12-21', '2021-01-01');
INSERT INTO `book`
VALUES (4, 'JavaWeb程序设计任务教程', '9787115439369', '人民邮电出版社', '传智播客', 419, 56, '2020-12-14', '0', NULL,
        NULL, NULL);
INSERT INTO `book`
VALUES (5, 'Java基础入门（第2版）', '9787302511410', '清华大学出版社', '传智播客', 413, 59, '2020-12-15', '0', NULL, NULL,
        NULL);
INSERT INTO `book`
VALUES (6, 'SpringCloud微服务架构开发', '9787115529046', '人民邮电出版社', '传智播客', 196, 43, '2020-12-16', '0', NULL,
        NULL, NULL);
INSERT INTO `book`
VALUES (7, 'SpringBoot企业级开发教程', '9787115512796', '人民邮电出版社', '传智播客', 270, 56, '2020-12-17', '0', NULL,
        NULL, NULL);
INSERT INTO `book`
VALUES (8, 'Spark大数据分析与实战', '9787302534327', '清华大学出版社', '传智播客', 228, 49, '2020-12-18', '0', '', '',
        '');
INSERT INTO `book`
VALUES (10, '边城', '9787543067028', '武汉出版社', '沈从文', 368, 26, '2020-12-20', '0', '', '', '');
INSERT INTO `book`
VALUES (12, '自在独行', '9787535488473', '长江文艺出版社', '贾平凹', 320, 39, '2020-12-22', '3', NULL, NULL, NULL);
INSERT INTO `book`
VALUES (13, '沉默的巡游', '9787544280662', '南海出版公司', '东野圭吾', 400, 59, '2020-12-23', '0', '', '', '');
INSERT INTO `book`
VALUES (14, '围城', '9787020127894', '人民文学出版社', '钱钟书', 382, 25, '2020-12-18', '0', '', NULL, NULL);
...
-- ----------------------------
INSERT INTO `record`
VALUES (23, 'Java基础案例教程（第2版）', '9787115547477', '张三', '2020-12-21', '2020-12-21');
INSERT INTO `record`
VALUES (24, 'Spark大数据分析与实战', '9787302534327', '黑马程序员', '2021-01-04', '2021-01-04');
INSERT INTO `record`
VALUES (26, '边城', '9787543067028', '黑马程序员', '2020-12-17', '2021-01-04');
...
(
    ...
    `user_hiredate`      varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户入职时间',
    `user_role`          varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户角色',
    `user_departuredate` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户离职时间',
...
-- ----------------------------
INSERT INTO `user`
VALUES (1, '黑马程序员', '12345', 'itheima@itcast.cn', '2021-01-05', 'ADMIN', NULL, '0');
INSERT INTO `user`
VALUES (2, '张三', '12345', 'zhangsan@itcast.cn', '2021-01-07', 'USER', NULL, '0');
